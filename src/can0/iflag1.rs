...
impl From<BUF4TO1I_A> for u8 {
    #[inline(always)]
    fn from(variant: BUF4TO1I_A) -> Self {
        variant as _
    }
}
#[doc = "Reader of field `BUF4TO1I`"]
pub type BUF4TO1I_R = crate::R<u8, BUF4TO1I_A>;
impl BUF4TO1I_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> crate::Variant<u8, BUF4TO1I_A> {
        use crate::Variant::*;
        match self.bits {
            0 => Val(BUF4TO1I_A::_0),
            1 => Val(BUF4TO1I_A::_1),
...
impl<'a> BUF4TO1I_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: BUF4TO1I_A) -> &'a mut W {
        unsafe { self.bits(variant.into()) }
    }
    #[doc = "The corresponding buffer has no occurrence of successfully completed transmission or reception when MCR\\[RFEN\\]=0."]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(BUF4TO1I_A::_0)
    }
    #[doc = "The corresponding buffer has successfully completed transmission or reception when MCR\\[RFEN\\]=0."]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
        self.variant(BUF4TO1I_A::_1)
    }
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]

...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum PFLSH_A {
    #[doc = "0: For devices with FlexNVM: FTFE configuration supports two logical program flash blocks and two logical FlexNVM blocks For devices with program flash only: Reserved"]
    _0 = 0,
    #[doc = "1: For devices with FlexNVM: Reserved For devices with program flash only: FTFE configuration supports four logical program flash blocks"]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum SWAP_A {
    #[doc = "0: For devices with FlexNVM: Logical program flash 0 block is located at relative address 0x0000 For devices with program flash only: Logical program flash 0 block is located at relative address 0x0000"]
    _0 = 0,
    #[doc = "1: For devices with FlexNVM: Reserved For devices with program flash only: Logical program flash 1 block is located at relative address 0x0000"]
    _1 = 1,
}
